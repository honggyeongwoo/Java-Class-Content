...
Student(String 이름, int 나이, double 키,
double 몸무게, int 학년, String 전공){
this.이름 = 이름;
this.나이 = 나이;
this.몸무게 = 몸무게;
this.전공 = 전공;
...
/*
 * 잠깐 데이터를 전달만 하고 끝나니?
 *  배달 주문 수량- 음식을 만들고 나면 끝나요! (매개변수)
 *            피자 두판 주세요! 김치찌개 한그릇 주세요!
 *  계산기에 입력하는 숫자들
 *  엘리베이터 층수 버튼 
 *  택시 탑승하면 목적지 
 * 
...
////		System.out.println(A.나이);
////		System.out.println(A.키);
////		System.out.println(A.몸무게);
////		System.out.println(A.학년);
////		System.out.println(A.전공);
//
//		직원 B = new 직원();
//
//		B.이름 = "김마리";
...
//		System.out.println(B.나이);
//		System.out.println(B.키);
//		System.out.println(B.몸무게);
//		System.out.println(B.급여);
//		System.out.println(B.부서);
//	}
//}
