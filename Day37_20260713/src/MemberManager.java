...
// 2. 회원목록을 돌면서 아이디와 비밀번호가 일치하는 회원 찾기
    ...
    // -2. 비교 equlas()
    if(하나의대상.아이디.equals(입력아이디) && 
       하나의대상.비밀번호.equals(입력비밀번호)) {
       System.out.println(하나의대상.이름 +
       "님, 로그인 성공!");
       break; 
    }else {
...
//import java.util.Scanner;
//
//// 파일명 MemberManger.java
//// 실무에서 네이밍(작명)할때 사용하는 프로그램 구조
//// MemberManger or MemberSystem
//
//// 메뉴 
////  1. 회원가입
////  2. 로그인
...
//       하나의대상.비밀번호.equals(입력비밀번호)) {
//       System.out.println(하나의대상.이름 +
//       "님 안녕하세요" + "아이디는 : " + 하나의대상.아이디 + "비밀번호는 : " +하나의대상.비밀번호);
//       break;
//    }else {
//    System.out.println("아이디 비번확인하세요!");
//    }
